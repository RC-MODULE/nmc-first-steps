...
Имеется возможность пошаговой отладки программ в режиме эммуляции с помощью отладчика emudbg из состава старого NMSDK (legacy).  
...
4. Загрузить в отладчикe "Target\Load Program..." исполняемый abs-файл ("d:\GIT\nmc-first-steps\Tutorial\Step01\make_emu6405\main.abs")  
5. Настроить окна 
