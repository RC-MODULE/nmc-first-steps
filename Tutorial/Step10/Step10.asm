...
data ".data"	
	Masks: long[24] = 
       (0000000000000001hl,      // матрица для первого прохода
        0000000000010000hl,	
        0000000100000000hl,	
        0001000000000000hl,	
        0000000000000000hl dup 4,	
        	
        0000000000000001hl,      // матрица для второго прохода
        0000000000000100hl,	
        0000000000010000hl,	
        0000000001000000hl,	
        	
        0000000000000000hl dup 4,// матрица для третьего 
        0000000000000001hl,      // прохода
        0000000000010000hl,	
        0000000100000000hl,	
        0001000000000000hl,	
        	
        0000000100000000hl,      // матрица для четвЄртого 
...
<_AddSaturate>	
	...
	f1cr = 0FF80FF80h;// конфигурация арифметической функции активации
		
    // определение конфигурации рабочей матрицы для первого шага вычислений
    nb1 = 80008000h;  // 4 столбца
    sb  = 03030303h;  // 8 строк
		
    // сразу все весовые коэффициенты (для четырЄх матриц) загружаются в wfifo,
